  ...
  public:
                ...
                size_t size)
    {
        ...
        if(trigger)
        {
            ...
            hold_counter_
                = static_cast<int>((0.04f + decay * 0.03f) * kSampleRate);
        }
